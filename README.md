...
Чтение **Канционере** Петrarca (366 стихотворений, 7785 строк) вместе с комментариями пяти изданий: построчный поиск, сравнение gloss на одной строке, веб-интерфейс и CLI.

| Слой | Что это |
|------|---------|
| **Якорный текст** | Итальянский текст всех 366 стихотворений (нумерация Канционере) |
